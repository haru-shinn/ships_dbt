...
/root/.local/bin/create-dagster project dg-project
...
```bash
# requirements.txtのみインストール
# vscode拡張機能は未インストール
# Version確認
sqlfluff --version
# 手動実行
sqlfluff lint /app/dbt_models/models/staging/
sqlfluff lint /app/dbt_models/models/intermediate
```
